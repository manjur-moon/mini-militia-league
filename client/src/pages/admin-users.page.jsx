      ...
      <div className="mt-4 flex flex-wrap gap-2">
        ...
        {user.linkedPlayerId ? (
          <button
            ...
            className="rounded-xl border border-red-300 px-4 py-2.5 font-bold text-red-600 hover:bg-red-50 disabled:cursor-not-allowed disabled:opacity-50 dark:border-red-900 dark:text-red-400 dark:hover:bg-red-950/30"
          >
            Unlink
          </button>
        ) : null}

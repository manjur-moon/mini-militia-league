...
const matchResultSchema = new mongoose.Schema(
  {
    ...
    extracted: {
      type: extractedResultSchema,
      required: true,
    },

    playerMatch: {
      type: playerMatchSchema,
      required: true,
      default: () => ({}),
    },

    corrected: {
      type: correctedResultSchema,
      default: null,
    },

    official: {
      type: officialResultSchema,
      default: null,
    },
...
/**
 * Every OCR/manual row must have a unique row index
...
/**
 * The same player cannot appear more than once
 * in the official results of the same verified match.
 */
matchResultSchema.index(
  {
    matchId: 1,
...
/**
 * Placement is intentionally NOT unique.
 *
 * Equal kills may produce equal dense placements:
 * kills:      21, 21, 18, 12
 * placement:   1,  1,  2,  3
 */
matchResultSchema.index(
